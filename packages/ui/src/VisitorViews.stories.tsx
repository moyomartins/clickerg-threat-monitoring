...
function ExpandableDemo() {
  ...
  return <VisitorScanRow {...base} expanded={open} onToggle={() => setOpen(!open)} />;
}
const base = { status: 'blocked' as const, ip: '192.0.2.52', location: 'Sao Paulo, Brazil', summary: 'Three paid clicks before the decision, no engagement on any.', confidence: '93%', paid: '10', spend: '£56.22', lastSeen: '46m ago', source: 'Google Ads, uk-brand-exact', replay: { scrollPct: 0, dwellSec: 2, clicks: 0, mouseMoves: 0 } };
